...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-transparent px-0 mb-1">
    ...
    <li class="breadcrumb-item active text-dark" aria-current="page">MEd (Digital Technologies)</li>
  </ol>
</nav>
...
<div class="project-description">
    ...
    <div class="row">
        <div class="col-md-5 offset-md-4">
            <figure>
                ...
                >
                <figcaption class="figure-caption text-dark text-center">The MEd (Technologies) program was online, so we got used to seeing our students through our computer screens</figcaption>
            </figure>
        </div>
    </div>
    <h2>About</h2>
    <h3 class="my-3">My role</h3>
    <p>
    ...
    <h3 class="my-3">Learn more about the MEd (DT)</h3>
    <p>
