...
I'd found a gig on Tokyo Gig Guide that had two bands from Poland ([Silver Rocket](https://silverrocketmusic.bandcamp.com/){:class="text-info" target="_blank"} and [Happy Pills](https://www.happypillsband.com/){:class="text-info" target="_blank"}) headlining at [Hard Rain](http://hardrain-web.net/top.html){:class="text-info" target="_blank"} in Osaka.
...
- [Hakugawa Shuhei](https://hakugawa628.wixsite.com/haku){:class="text-info" target="_blank"}
- [Vincent Naga](https://vincentnaga.bandcamp.com){:class="text-info" target="_blank"} (and his band)
...
We also talked to the tour manager for the Silver Rocket & Happy Pills tour, who worked for [Moorworks Travel](https://moorworks.com/){:class="text-info" target="_blank"}, about some of his recommendations for music venues in Osaka and Tokyo and his travels in Australia.
We had to make sure we got a train back to Kyoto in time, so we said our goodbyes and headed to the train station.

[< Days 7-8](tokyo-4){:class="text-info float-start py-3 page-navigation"}
[Days 11-12 >](kyoto-2){:class="text-info float-end py-3 page-navigation"}